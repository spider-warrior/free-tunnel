...
public class HttpProxyServer {
    public static void main(String[] args) {
        ...
        NettyTcpServer proxyServer = new NettyTcpServer("http-proxy-server", HttpProxyServerConfig.SERVER_PORT, nettyChannelInitializer, TunnelConstants.WORKER_GROUP, false, true);
